...
- 雑談/自己紹介: 基本的にどんな話題も歓迎です。初めて参加される方は、よろしければ自己紹介を投稿してみてください。
   - 自己紹介は既存の [自己紹介スレ](aaa) に新しくコメントを付けて投稿してください。コメントの付け方は後述します。
...
ラベルは運営者のみ作成できますので、追加リクエストを [ラベル追加リクエスト](aaa) のDiscussionで受け付けています。
...
[ご意見・ご要望](aaa) のDiscussionで、このスペースへのご意見・ご要望を受け付けています。いただいた内容を今後のスペース改善の参考とさせていただきます。

## todo's

- [x] カテゴリの整備
- [x] 使い方を詳細に書く / 正確な手順に直す
- [ ] コンテンツを充実させる
- [ ] 仲間を呼び込む
